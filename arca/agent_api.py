...
class ARCAAgentBackend:
    """Framework-neutral, multi-turn adapter for agent loops.

    Upgrades: session memory, bounded context, reference resolution, intent
    routing, salience extraction, compression, quality filtering, telemetry,
    persistent sessions and explicit model provenance.
    """
